        ...
        <div class="container">
            <div class="login-box">
                ...
                <div class="form-group floating-form-group">
                    <input id="name" type="text" class="form-control floating-input" value="" required>
                    <label class="floating-label">Name</label>
                </div>
                <div class="form-group floating-form-group">
                    <input id="nick" type="text" class="form-control floating-input" value="" required>
                    <label class="floating-label">Nickname</label>
                </div>
                <div class="form-group floating-form-group">
                    <input id="email" type="email" class="form-control floating-input" value="" autofocus required>
                    <label class="floating-label">Email Address</label>
                </div>
                <div class="form-group floating-form-group">
                    <input id="passw" type="password" class="form-control floating-input" required>
                ...
                <a href="#" class="btn btn-block btn-danger btn-lg signupbtn">Sign Up</a>
            </div>
        </div>
    </main>
    ...
    <script>
        ...
        $(".signupbtn").on("click", function(e){
            ...
            var name = $("#name").val(),
                ...
                email = $("#email").val(),
                pass = $("#passw").val();            
            if(name != "" && nick != "" && email != "" && pass != ""){
                $.post("API/AUT/register", { name: name, nick: nick, email: email, p: pass}).done(function(data){
