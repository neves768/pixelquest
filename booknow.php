...
<body class="d-flex flex-column h-100 menu-overlay">
    ...
    <main class="flex-shrink-0">
        ...
        <div class="container mt-4">
            <div class="row">
                <div class="col"><h4 class="">600.00 <sup class="small"><small>USD</small></sup></h4></div>
                <div class="col-auto"><p class="small text-secondary">2 BHK</p></div>
                <div class="col-12"><p class="small text-secondary">+ $ 20.00 USD Gym</p></div>
            </div>
            
            <div class="card product-card-small my-4">
                <div class="card-body">
                    <div class="row">
                        <div class="col-auto">
                            <div class="product-image-small">
                                <div class="background" style="background-image: url(_img/image-5.html);">
            ...
            <div class="row">
                <div class="col-12 col-md-6">
                    <div class="form-group floating-form-group">
                        <input type="text" class="form-control floating-input" value="Amay Johnson">
                    ...
                    <div class="form-group floating-form-group active">
                        <div class="row">
                            <div class="col-2 col-md-1">
                                <input type="text" class="form-control floating-input" value="91">
                            </div>
                            <div class="col">
                ...
                <div class="col-12 col-md-6">
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group floating-form-group active">
                                <input type="date" class="form-control floating-input" placeholder>
                                <label class="floating-label">Arrival</label>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group floating-form-group active">
                                <input type="date" class="form-control floating-input">
                                <label class="floating-label">Departure</label>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <label class="checkbox-lable" for="sport">
                                <span class="image-boxed text-white">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="icon-size-48 vm" viewBox="0 0 512 512">
                                        ...
                                        <polyline points="256 175.15 256 117.58 320 74.94" style="fill:none;stroke:#000;stroke-linecap:round;stroke-linejoin:round;stroke-width:32px"></polyline>
                                        <line x1="192" y1="74.93" x2="256" y2="117.58" style="fill:none;stroke:#000;stroke-linecap:round;stroke-linejoin:round;stroke-width:32px"></line>
                                        <polyline points="312 320 340 368 312 439" style="fill:none;stroke:#fff;stroke-linecap:round;stroke-linejoin:round;stroke-width:32px"></polyline>
                                        <line x1="410.74" y1="368" x2="342" y2="368" style="fill:none;stroke:#000;stroke-linecap:round;stroke-linejoin:round;stroke-width:32px"></line>
                                        <polyline points="200 320 172 368 200.37 439.5" style="fill:none;stroke:#fff;stroke-linecap:round;stroke-linejoin:round;stroke-width:32px"></polyline>
                                        <line x1="101.63" y1="368" x2="172" y2="368" style="fill:none;stroke:#fff;stroke-linecap:round;stroke-linejoin:round;stroke-width:32px"></line>
                                    </svg>
                                </span>
            ...
            <div class="row my-4">
                <div class="col-12 col-md-6 col-lg-4 mx-auto">
                    <div class="form-group">
                        <p class="text-secondary">By Clicking button below you are agree to the <a href="#" class="link">terms and Condition</a> of the app</p>
                    </div>
                    <br>
                    <a href="confirm.html" class="btn btn-block btn-danger btn-lg">Book Now</a>
                </div>
            </div>
        </div>
    </main>
