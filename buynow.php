...
<body class="d-flex flex-column h-100 menu-overlay">
    ...
    <main class="flex-shrink-0">
        ...
        <div class="container mt-4">
            <h4 class="mb-3">1,200,000.00 USD</h4>
            <div class="card product-card-small mb-4">
                <div class="card-body">
                    <div class="row">
                        <div class="col-auto">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-md-6">
                    <div class="form-group floating-form-group">
                        <input type="text" class="form-control floating-input" value="1,200,000.00 ">
                        <label class="floating-label">Amount to offer</label>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-12 col-md-6 col-lg-4 mx-auto">
                    ...
                    <br>
                    <a href="thankyou.html" class="btn btn-block btn-danger btn-lg">Submit</a>
                </div>
            </div>
        </div>
    </main>
