...
<body class="body-scroll d-flex flex-column h-100 menu-overlay">
    ...
    <main class="flex-shrink-0">
        ...
        <div class="container mt-4">
            <p class="text-secondary text-center"><span class="text-dark">5 New Bookings</span> found</p>
            <div class="row">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col pl-0">
                                    <div class="row">
                                        <div class="col">
                                            <p class="small">Exoticasi Duplex </p>
                                        </div>
                                        <div class="col-auto">
                                            <p class="small vm">
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group floating-form-group active mb-0">
                                        <p class="form-text small mb-0">22/08/2020</p>
                                        <label class="floating-label">Arrival</label>
                                    </div>
                                </div>
                                <div class="col pl-0">
                                    <div class="form-group floating-form-group active mb-0">
                                        <p class="form-text small mb-0">24/08/2020</p>
                                        <label class="floating-label">Departure</label>
                                    </div>
                                </div>
                                <div class="col-auto pl-0">
                                    <div class="form-group floating-form-group active mb-0">
                                        <p class="form-text small mb-0">600 USD</p>
                ...
                <div class="col-12 col-md-6 col-lg-6">
                    <div class="card product-card-small mb-3">
                        <div class="upcoming"><p class="mb-0 font-weight-medium">Upcoming</p></div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-auto">
                                    <div class="product-image-small">
                                        <div class="background" style="background-image: url(_img/image-3.html);">
                                            <img src="img/image-6.jpg" alt="" style="display: none;">
                                        </div>
                                        <div class="tag-images-count text-white bg-dark">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="icon-size-16 vm" viewBox="0 0 512 512">
                                                <title>ionicons-v5-e</title>
                        ...
                        <div class="card-footer border-top border-color">
                            <div class="row">
                                ...
                                <div class="col-auto pl-0">
                                    <div class="form-group floating-form-group active mb-0">
                                        <p class="form-text small mb-0">800 USD</p>
                                        <label class="floating-label">Amount</label>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-12 col-md-6 col-lg-6">
                    <div class="card product-card-small mb-3">
                        <div class="upcoming bg-secondary"><p class="mb-0 font-weight-medium">Expired</p></div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-auto">
                                    <div class="product-image-small">
                        ...
                        <div class="card-footer border-top border-color">
                            <div class="row">
                                ...
                                <div class="col-auto pl-0">
                                    <div class="form-group floating-form-group active mb-0">
                                        <p class="form-text small mb-0">1200 USD</p>
                                        <label class="floating-label">Amount</label>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-12 col-md-6 col-lg-6">
                    <div class="card product-card-small mb-3">
                        <div class="upcoming bg-info"><p class="mb-0 font-weight-medium">Refunded</p></div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-auto">
                                    <div class="product-image-small">
                ...
                <div class="col-12 col-md-6 col-lg-6">
                    <div class="card product-card-small mb-3">
                        <div class="upcoming bg-danger"><p class="mb-0 font-weight-medium">Completed</p></div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-auto">
                                    <div class="product-image-small">
